...
var INSERT_TESTS = {
  ...
  comment:    'Assumptions:' +
              '<ul>' +
                '<li>Result selection should be placed after the newly created element, collapsed, in order to allow successive insert operations.</li>' +
                '<li>An non-wrapping insert operation on a non-collapsed selection should be equivalent to a delete operation followed by the insert operation.</li>' +
