...
class ParseTest(unittest.TestCase):
    def testBrowserscopeStrings(self):
        self.runUserAgentTestsFromYAML('/test/resources/test_user_agent_parser.yaml')
        
    def testBrowserscopeStringsOS(self):
        self.runOSTestsFromYAML('/test/resources/test_user_agent_parser_os.yaml')
        
    def testStringsOS(self):
        self.runOSTestsFromYAML('/test/resources/additional_os_tests.yaml')
        
    def testMozillaStrings(self):
        self.runUserAgentTestsFromYAML('/test/resources/firefox_user_agent_strings.yaml')
    ...
    # reconcile the differences betwee the two YAML files.
    def testPGTSStrings(self):
        self.runUserAgentTestsFromYAML('/test/resources/pgts_browser_list.yaml')
